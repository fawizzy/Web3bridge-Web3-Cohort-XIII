...
export interface IBADAN_20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DECIMALS"
      | "NAME"
...
export interface IBADAN_20 extends BaseContract {
  connect(runner?: ContractRunner | null): IBADAN_20;
  waitForDeployment(): Promise<this>;

  interface: IBADAN_20Interface;
