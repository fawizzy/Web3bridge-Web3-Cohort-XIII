...
export interface CHILD_TOKENInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DECIMALS"
      | "NAME"
...
export interface CHILD_TOKEN extends BaseContract {
  connect(runner?: ContractRunner | null): CHILD_TOKEN;
  waitForDeployment(): Promise<this>;

  interface: CHILD_TOKENInterface;
